...
# 爬取间隔设置，单位秒
# 帖子之间的爬取延时区间
DOUYIN_POST_INTERVAL_RANGE = (1, 2)
WEIBO_POST_INTERVAL_RANGE = (1, 2)
XHS_POST_INTERVAL_RANGE = (1, 2)
TIEBA_POST_INTERVAL_RANGE = (1, 2)

# 评论之间的爬取延时区间
DOUYIN_COMMENT_INTERVAL_RANGE = (1, 3)
WEIBO_COMMENT_INTERVAL_RANGE = (1, 3)
XHS_COMMENT_INTERVAL_RANGE = (1, 3)
TIEBA_COMMENT_INTERVAL_RANGE = (1, 3)
